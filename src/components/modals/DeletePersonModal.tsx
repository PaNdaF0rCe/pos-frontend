...
import { deletePerson } from "../../db/mutations/creditMutate";
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    This will remove this person and their entire credit history. Continue?
                  </p>
                </div>
                ...
                <div className="mt-4">
                  <button
                    ...
                    onClick={async () => {
                      await deletePerson(selectedPerson?.id!, entryIds);
                      closeModal();
                    }}
                  >
                    Yes, please!
